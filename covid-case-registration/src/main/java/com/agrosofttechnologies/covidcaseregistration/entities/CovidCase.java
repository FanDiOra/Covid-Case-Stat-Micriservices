...
public class CovidCase implements Serializable {
	...
	public String toString() {
		return "CovidCase [caseID=" + caseID + ", source=" + source + ", caseType=" + caseType + ", firstName="
				+ firstName + ", lastName=" + lastName + ", phone=" + phone + ", email=" + email + ", dateOfBirth="
				+ dateOfBirth + ", nationalID=" + nationalID + ", nationalIDType=" + nationalIDType + ", address="
				+ address + "]";
	}
